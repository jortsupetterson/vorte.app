/**
 * Redirects the incoming request URL to Google’s OAuth 2.0 authorization endpoint using PKCE.
 *
 * @param {URL} url
 ...
 *     The redirect URI registered in Google OAuth client settings,
 *     e.g. `https://your-app.com/auth/callback/google`.
 * @returns {Response}
 *   - A 302 Redirect to Google’s `/o/oauth2/v2/auth` endpoint with these query params:
 ...
 *   @param {string} env.GOOGLE_CLIENT_ID
 *     The OAuth 2.0 Client ID obtained from Google Cloud Console.
 *   @param {string} env.GOOGLE_AUTH_REDIRECT_URI
